    ...
    <div>
      <div className="animate-fade-up mb-8">
        <h1 className="font-[family-name:var(--font-display)] text-3xl font-700 tracking-tight">
          Welcome back, <span className="text-accent">{dealer?.name || 'Dealer'}</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        {[
          ...
          { label: 'Pending', value: pendingVehicles.toString(), sub: pendingVehicles > 0 ? 'Ready to process' : 'All caught up', color: pendingVehicles > 0 ? 'text-accent' : '' },
      ...
      <div className="animate-fade-up" style={{ animationDelay: '400ms' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            ...
            className="group cursor-pointer bg-surface border border-border rounded-xl p-6 hover:border-accent/30 hover:bg-accent-glow transition-all"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium group-hover:text-accent transition-colors">Process Pending</p>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium group-hover:text-accent transition-colors">View Inventory</p>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium group-hover:text-accent transition-colors">Branding Settings</p>
